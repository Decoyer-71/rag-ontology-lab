...
description: C:\projects\rag-ontology-lab 는 RAG·온톨로지를 손으로 짜서 배우는 학습 실습실이자 기업 지원 포트폴리오다
metadata:
  type: project
---

`C:\projects\rag-ontology-lab` — RAG·온톨로지 **학습 실습실**. 2026-09-10 환경 구축 완료, 학습은 미착수.
